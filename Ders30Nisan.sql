...
/* -----------------------------------------------------------------------------
  ...
  alinan sehirleri gosteren sorguyu Tekrarlı verileri de gösterecek şekilde
  yaziniz.
------------------------------------------------------------------------------*/

SELECT isim AS isim_veya_sehir
FROM personelset
WHERE maas>4000
UNION ALL
SELECT sehir
...
/* -----------------------------------------------------------------------------
  ORNEK7: 5000’den az maas alan ve Honda calisani olmayanların bilgilerini
...
------------------------------------------------------------------------------*/     
  ...
  MINUS                                      -- >>    degili  
  SELECT isim,sehir FROM personel --          ||| 
  WHERE sehir = 'Istanbul';         -- >>sehri istanbul olan
